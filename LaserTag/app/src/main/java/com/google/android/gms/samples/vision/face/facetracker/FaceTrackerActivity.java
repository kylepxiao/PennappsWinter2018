...
public final class FaceTrackerActivity extends AppCompatActivity {
    ...
    */
    ...
    public void onCreate(Bundle icicle) {
        ...
        ImageView demoImage = (ImageView)findViewById(R.id.empty);

        int imagesToShow[] = { R.drawable.laser_01, R.drawable.laser_02, R.drawable.laser_03, R.drawable.laser_04, R.drawable.laser_05, R.drawable.laser_06 };
